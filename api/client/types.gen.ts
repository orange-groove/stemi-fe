...
export type GetSessionPreviewData = {
  path: {
    session_id: string
  }
}
...
export type SessionPreview = {
  available_stems?: Array<string>
  session_id?: string
}

export type GetSessionPreviewResponse = SessionPreview

export type GetSessionPreviewError = {
  error?: string
}

export type DownloadSessionStemsData = {
  body: {
    stems?: Array<string>
    file_type?: string
  }
...
export type DownloadSessionStemsResponse = Blob | File

export type DownloadSessionStemsError = {
  error?: string
}

export type DownloadSessionMixdownData = {
  body: {
    stems?: Array<string>
    file_type?: string
  }
...
export type DownloadSessionMixdownResponse = Blob | File

export type DownloadSessionMixdownError = {
  error?: string
}
...
export type GetSessionStemData = {
  path: {
    session_id: string
    stem_name: string
  }
...
export type GetSessionStemResponse = Blob | File

export type GetSessionStemError = {
  error?: string
}
