...
import type { CreatePlaylistData, CreatePlaylistError, CreatePlaylistResponse, GetAllPlaylistsData, GetAllPlaylistsError, GetAllPlaylistsResponse, GetPlaylistData, GetPlaylistError, GetPlaylistResponse, UpdatePlaylistData, UpdatePlaylistError, UpdatePlaylistResponse, DeletePlaylistData, DeletePlaylistError, DeletePlaylistResponse, GetPlaylistSongsData, GetPlaylistSongsError, GetPlaylistSongsResponse, CreateSongData, CreateSongError, CreateSongResponse, GetAllSongsData, GetAllSongsError, GetAllSongsResponse, UpdateSongData, UpdateSongError, UpdateSongResponse, DeleteSongData, DeleteSongError, DeleteSongResponse } from './types.gen';
 ...
 */
export const getAllPlaylists = <ThrowOnError extends boolean = false>(options: Options<GetAllPlaylistsData, ThrowOnError>) => {
