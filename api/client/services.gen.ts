...
import type { CreatePlaylistData, CreatePlaylistError, CreatePlaylistResponse, GetAllPlaylistsError, GetAllPlaylistsResponse, GetPlaylistData, GetPlaylistError, GetPlaylistResponse, UpdatePlaylistData, UpdatePlaylistError, UpdatePlaylistResponse, DeletePlaylistData, DeletePlaylistError, DeletePlaylistResponse, GetPlaylistSongsData, GetPlaylistSongsError, GetPlaylistSongsResponse, AddPlaylistSongData, AddPlaylistSongError, AddPlaylistSongResponse, DeletePlaylistSongData, DeletePlaylistSongError, DeletePlaylistSongResponse, CreateSongData, CreateSongError, CreateSongResponse, GetAllSongsError, GetAllSongsResponse, GetSongData, GetSongError, GetSongResponse, UpdateSongData, UpdateSongError, UpdateSongResponse, DeleteSongData, DeleteSongError, DeleteSongResponse, GetSampleSongError, GetSampleSongResponse, DownloadStemsData, DownloadStemsError, DownloadStemsResponse, DownloadMixdownData, DownloadMixdownError, DownloadMixdownResponse } from './types.gen';
 ...
 * Add a song to a playlist.
 */
export const addPlaylistSong = <ThrowOnError extends boolean = false>(options: Options<AddPlaylistSongData, ThrowOnError>) => {
    return (options?.client ?? client).post<AddPlaylistSongResponse, AddPlaylistSongError, ThrowOnError>({
        ...options,
 ...
 * Delete a song from a playlist
 */
export const deletePlaylistSong = <ThrowOnError extends boolean = false>(options: Options<DeletePlaylistSongData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeletePlaylistSongResponse, DeletePlaylistSongError, ThrowOnError>({
        ...options,
        url: '/playlist/{playlist_id}/song/{song_id}'
    });
};
 ...
 */
export const getAllSongs = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
 ...
 * Get the sample song.
 */
export const getSampleSong = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetSampleSongResponse, GetSampleSongError, ThrowOnError>({
        ...options,
        url: '/song/sample'
    });
};
