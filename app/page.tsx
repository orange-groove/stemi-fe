  ...
  return (
    <>
      <SEO
        ...
        description="Separate any song into individual stems with AI-powered precision. Upload, preview, and download isolated tracks for vocals, drums, bass, and more. Professional stem separation for music producers."
        keywords={[
          'stem separation',
          'AI music',
          'audio processing',
